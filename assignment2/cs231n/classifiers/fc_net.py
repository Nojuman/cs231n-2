...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    dl1, dW2, db2 = affine_backward(dscores, l2_cache)
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    for i in range(self.num_layers - 1):
      cache = []
      # affine forward
      temp, fc_cache = affine_forward(ipt, self.params['W' + str(i + 1)], self.params['b' + str(i + 1)])
    ...
    scores, cache = affine_forward(ipt, self.params['W' + str(self.num_layers)], self.params['b' + str(self.num_layers)])
    cache_list.append(cache)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
